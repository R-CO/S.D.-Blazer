...
class Robot {
	...
	drawBack() {
		push();
		translate(0, this.half_back_y - this.half_body_y, (-1) * (this.half_body_z + this.half_back_z));
	...
	drawUpperArmL() {
		push();
		translate(this.half_body_x + this.half_upper_arm_x, (-1) * this.half_upper_arm_y - 5, 0);
	...
	drawUpperArmR() {
		push();
		translate((-1) * (this.body_x + this.upper_arm_x) / 2, (-1) * this.upper_arm_y / 2 - 5, 0);
		//rotate(radians(30), 1, 0, 0);
